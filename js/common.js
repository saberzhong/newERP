$(function () {
  ...
  $('.content_left_dl a').on('click', function () {
    ...
    $.get('forward!yearAndPeriod.action?rnd=' + Math.random(), function (data) {
      ...
      $('#currentTime').text('第' + data.year + '年，第' + data.period + '期');
...
$(function () {
  ...
  last.click(function () {
    ...
    var html = [
      ...
      '<input type="button" value="确认" id="exitAll" class="sureBtn common_1 exitBgcolor common_border common_color" /></p>'
    ].join('');
